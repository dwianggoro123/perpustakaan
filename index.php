...
<body>
   <!--Navbar-->
   <nav class="navbar fixed-top navbar-expand-lg bg-secondary shadow-sm justify-space-between">
   ...
   <section id="homeSection" class="p-3">
      <div class="d-flex flex-wrap justify-content-center">
         <div class="col mt-5">
            <h2 class="fw-bold text-secondary"><span class="text-secondary">dunia</span>buku</h2>
            <a class="btn btn-dark" href="sign/link_login.html">Get started</a>
         </div>
      </div>
   </section>
   <?php
      ...
      <div id="carouselExampleControlsNoTouching " class="carousel slide" data-bs-touch="false">
         <div class="carousel-inner">
            <div class="carousel-item active">
               <img src="./assets/duniabuku.png" class="d-block w-100 rounded" alt="...">
            </div>
            <div class="carousel-item">
               <img src="./assets/duniabuku.png" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
               <img src="./assets/duniabuku.png" class="d-block w-100" alt="...">
            </div>
